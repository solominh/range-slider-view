...
/**
 * FIX BUGS:
 * 1. Add method: getCurrentIndex
 * 2. Draw bars before draw slots
 * 3. Fix width =0;
 * 4. Fix array index out of bound
 * 5. Remove ripple animation
 */
...
public class RangeSliderView extends View {
    ...
    /**
     * Should reinitialize slotPositions array. Otherwise, error index out of bound happen
     */
    public void setRangeCount(int rangeCount) {
        ...
        this.slotPositions = new float[rangeCount];
    }
